"""
Prompt Builder — dynamic prompt assembly for Klar Analytics agents.
...
SYSTEM_TEMPLATE = """Eres {agent_name}, un agente especializado en {agent_role} de Klar Analytics.
...
class PromptBuilder:
    ...
    def _generic_system(self, context: Dict) -> str:
        return """Eres un analista de Klar Analytics, consultora especializada en diagnóstico empresarial para PyMEs.
